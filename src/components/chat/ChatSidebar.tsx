...
export const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  return (
    <div className="flex flex-col min-w-0 min-h-0 h-full bg-white/60 dark:bg-black/80 backdrop-blur-2xl
      ...
      {/* Top Bar: Friends and Settings */}
      <div className="flex items-center justify-between px-2 sm:px-3 pt-2 pb-1">
        <button
          onClick={onShowFriends}
          className="p-2 rounded-full text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-purple-500"
          title="Friends"
        >
